...
<form id="form" action="./proses/prosesubah.php" method="POST">
    ...
    <div class="panel-middle">
        ...
        <?php
        $query = "SELECT namaKriteria,id_nilaisupplier,id_kriteria FROM nilai_supplier INNER JOIN kriteria USING(id_kriteria) WHERE id_supplier='$a' AND id_jenisbarang='$b'";
        $execute = $konek->query($query);
